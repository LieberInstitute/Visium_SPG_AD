...
#fdr gene set
magma --gene-results /dcs04/lieber/lcolladotor/pilotLC_LIBD001/locus-c/code/magma/SNP_Data/AD_Jansen2019_LC_snp-wise.genes.raw --set-annot $fdr_gs gene-col=${genecol} set-col=${setcol} --out code/12_magma/01_Jansen_2019/ad_gwas_fdr_cutoff
