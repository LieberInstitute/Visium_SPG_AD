...
annoTab.full <- annoTab.full[, c(
    "names", "seqlevel", "start", "end", "strand",
    "symbol"
)]
...
write.table(snploc.AD,
    file = here("code", "magma", "GWAS_Results", "Alzheimers_PGC-IGAP-ADSP-UKB_2019.snploc"),
