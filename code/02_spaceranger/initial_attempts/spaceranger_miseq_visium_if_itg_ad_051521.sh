...
# fastq (NextSeq): /dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/Visium_SPG_AD/raw-data/FASTQ/FASTQ_10x_2021-05-03/
# images (raw): /dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/Visium_SPG_AD/raw-data/Images/
...
--fastqs=/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/Visium_SPG_AD/raw-data/FASTQ/FASTQ_10x_2021-05-03 \
--sample=1 \
--image=/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/Visium_SPG_AD/raw-data/Images/1_V10A27-004_A1_Br3874.tiff \
--slide=V10A27-004 \
--area=A1 \
--loupe-alignment=/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/Visium_SPG_AD/raw-data/Images/json/fluorescent/V10A27-004-A1.json \
--jobmode=local \
--localcores=8 \
--localmem=64
