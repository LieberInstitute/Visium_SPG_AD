...
#$ -pe local 4 
#$ -N dotdotdot
#$ -o /dcs04/lieber/lcolladotor/with10x_LIBD001/Visium_IF_AD/code/VistoSeg/logs/dotdotdot_VIFAD3.txt
#$ -e /dcs04/lieber/lcolladotor/with10x_LIBD001/Visium_IF_AD/code/VistoSeg/logs/dotdotdot_VIFAD3.txt
#$ -m e
...
echo "****"
echo "Sample id: VIFAD3_V10T31-036"
echo "****"
