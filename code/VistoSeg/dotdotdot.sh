...
#$ -pe local 4 
#$ -N dotdotdot
#$ -o /dcs04/lieber/lcolladotor/with10x_LIBD001/Visium_SPG_AD/code/VistoSeg/logs/dotdotdot_test.txt
#$ -e /dcs04/lieber/lcolladotor/with10x_LIBD001/Visium_SPG_AD/code/VistoSeg/logs/dotdotdot_test.txt
#$ -m e
