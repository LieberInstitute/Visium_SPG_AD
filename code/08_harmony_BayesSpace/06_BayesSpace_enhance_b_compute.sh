...
for spetype in wholegenome targeted; do
    ...
    SHORT="BayesSpace_enhance_b_compute_${spetype}"

    # Construct shell file
    echo "Creating script BayesSpace_enhance_b_compute_${spetype}"
    cat > .${SHORT}.sh <<EOF
#!/bin/bash
#$ -cwd
...
Rscript 06_BayesSpace_enhance_b_compute.R -s ${spetype}
