...
initial[["ReducedDimensionPlot1"]] <- new("ReducedDimensionPlot", Type = "PCA", XAxis = 1L, YAxis = 2L,
    ...
    ColorByFeatureDynamicSource = FALSE, ColorBySampleName = "V10A27004_D1_Br3880_none",
    ...
    CustomLabels = FALSE, CustomLabelsText = "V10A27004_D1_Br3880_none",
    FontSize = 1, LegendPointSize = 1, LegendPosition = "Bottom",
    HoverInfo = TRUE, LabelCenters = FALSE, LabelCentersBy = "APOe",
...
initial[["ComplexHeatmapPlot1"]] <- new("ComplexHeatmapPlot", Assay = "logcounts", CustomRows = TRUE,
    ...
    DataBoxOpen = FALSE, VisualChoices = "Annotations", ColumnData = c("path_groups",
    "subject"), RowData = character(0), CustomBounds = FALSE,
...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data",
    ...
    ShapeByColumnData = "APOe", SizeByColumnData = "age", FacetRowBy = "None",
