...
initial[["ReducedDimensionPlot1"]] <-
    new(
        ...
        XAxis = 1L,
        YAxis = 2L,
        FacetRowByColData = "APOe",
        FacetColumnByColData = "APOe",
        ColorByColumnData = "path_groups",
        ColorByFeatureNameAssay = "logcounts",
        ColorBySampleNameColor = "#FF0000",
        ShapeByColumnData = "APOe",
        ...
        ColorBySampleName = "V10A27004_D1_Br3880_none",
        ColorBySampleSource = "---",
        ...
        CustomLabels = FALSE,
        CustomLabelsText = "V10A27004_D1_Br3880_none",
        FontSize = 1,
        LegendPointSize = 1,
...
initial[["FeatureAssayPlot1"]] <-
    new(
        ...
        Assay = "logcounts",
        XAxis = "Column data",
        XAxisColumnData = "path_groups",
        XAxisFeatureName = "LINC01128",
        XAxisFeatureSource = "---",
        XAxisFeatureDynamicSource = FALSE,
        YAxisFeatureName = "RPN2",
