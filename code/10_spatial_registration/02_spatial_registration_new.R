# sgejobs::job_single(
#     name = "spatial_registration_new",
#     create_shell = TRUE,
#     queue = "bluejay",
#     memory = "10G",
#     command = "Rscript 02_spatial_registration_new.R",
#     create_logdir = TRUE
#
# )

## Perform spatial registration using new functions
##aggregateAcrossCells
##spatialLIBD correlation and heatmap functions
...
saveRDS(sce_pseudo, file = here::here("processed-data","10_spatial_registration", "pseudo_bulked",paste0("sce_pseudobulked_BayesSpace_new",k_nice,".RDS")))
...
saveRDS(corfit, file = here::here("processed-data","10_spatial_registration", "dupCor",paste0("pseudobulked_dupCor_k_new",k_nice,".RDS")))
...
saveRDS(eb0_list_cell, file = here::here("processed-data","10_spatial_registration", "specific_Ts",paste0("pseudobulked_specific_Ts_k_new",k_nice,".RDS")))
...
pdf(file = here::here("plots","10_spatial_registration",paste0("pseudobulked_bayesSpace_vs_mannual_annotations_k_new",k_nice,".pdf")), width = 8)
print(
    levelplot(
        cor_t_layer_toPlot,
        aspect = "fill",
